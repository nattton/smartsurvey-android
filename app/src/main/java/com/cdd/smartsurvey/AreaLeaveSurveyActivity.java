...
public class AreaLeaveSurveyActivity extends AppCompatActivity {
    ...
    public void SendData (String aurl) {
        Intent intent = new Intent(this, AreaCareerSurveyActivity.class);
    ...
    public void ShowRadioAreaOther()
    {
        ...
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(AreaLeaveSurveyActivity.this);
