...
public class Prefix {
    ...
    public static final String TABLE_NAME = "tbl_prefix_master";
    ...
    public Prefix(int id, String code, String codename, String create_by, String create_date, String modify_by, String modify_date) {
        this.id = id;
        this.code = code;
