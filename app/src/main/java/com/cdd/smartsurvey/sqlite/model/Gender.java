...
public class Gender {
    ...
    public static final String TABLE_NAME = "tbl_gender_master";
    ...
    public Gender(int id, String code, String codename, String create_by, String create_date, String modify_by, String modify_date) {
        this.id = id;
        this.code = code;
