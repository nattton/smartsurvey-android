...
public class Province {
    ...
    public static final String TABLE_NAME = "tbl_province_master";

    public static final String COLUMN_ID          = "id";
    public static final String COLUMN_CODE        = "provice_id";
    public static final String COLUMN_CODENAME    = "province_name";
    ...
    public Province(int id, String code, String codename, String create_by, String create_date, String modify_by, String modify_date) {
        this.id = id;
        this.code = code;
