...
public class Amphur {
    ...
    public static final String TABLE_NAME = "tbl_amphur_master";

    public static final String COLUMN_ID          = "id";
    public static final String COLUMN_CODE        = "amphur_id";
    public static final String COLUMN_CODENAME    = "amphur_name";
    ...
    public Amphur(int id, String code, String codename, String create_by, String create_date, String modify_by, String modify_date) {
        this.id = id;
        this.code = code;
